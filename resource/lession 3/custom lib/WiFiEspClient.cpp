...
String WiFiEspClient::IpAddress2String(const IPAddress& ipAddress)
{
...
String WiFiEspClient::getIPAddress(void)
{
	IPAddress test(192, 168, 43, 232); 
	// Get current assigned ip address
	return ( IpAddress2String(test) ) ;
}
